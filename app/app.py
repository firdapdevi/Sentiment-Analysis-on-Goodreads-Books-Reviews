...
st.write('Sentiment Analysis takes the text and identifies the emotional meanings behind it. This is useful in situations such as identifying negative texts, analyzing how people feel about brand or product, and better understanding customer needs in general.')
st.markdown('The model training and prediction code is covered in the corresponding GitHub repository https://github.com/firdapdevi/Sentiment-Analysis-on-Goodreads-Books-Reviews.')
